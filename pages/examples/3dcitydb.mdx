...
Therefore, set up the connection in the database tab and load the generated CityGML datasets into the database using the import tab:
![3DCityDB Query Answer](/media/demos/3dcitydb-importerexporter-connect.png)
...
![3DCityDB Query Answer](/media/demos/3dcitydb-importerexporter-export.png)
