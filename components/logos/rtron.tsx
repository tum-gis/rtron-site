const RtronLogo = ({ height = 20 }) => (
    <svg height={height} version="1.1" viewBox="0 0 100 39.76" xmlns="http://www.w3.org/2000/svg">
        ...
        <text transform="translate(12.94 37.82)" fill="#fff" fontFamily="OpenSans-Light, Open Sans" fontSize="32.171px" fontWeight="300">r:</text>
        <text transform="translate(35.55 37.82)" fill="#6d6e71" fontFamily="OpenSans-Light, Open Sans" fontSize="32.171px" fontWeight="300">tran</text>
        <ellipse cx="67.36" cy="14.96" rx="3.4" ry="3.33" fill="url(#linear-gradient-2)"/>
    </svg>
);

export default RtronLogo;
